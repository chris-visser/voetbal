    ...
    <main class="relative flex flex-wrap justify-between items-start w-full p-8 max-h-screen max-w-screen overflow-hidden">
        <div>
          ...
          <section class="p-8 bg-white rounded-md flex flex-col items-center">
            ...
            <img src="/restaurant-oudejans.webp" class="h-[150px] inline-block mb-2" alt="Sponsor wedstrijdbal - Restaurant Oudejans" />
            <p class="text-center max-w-[400px]">
              De wedstrijdbal van het 1e elftal wordt gesponsord door Restaurant Oudejans - de perfecte plek voor een goede lunch,
